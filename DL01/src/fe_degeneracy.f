      SUBROUTINE FE_DEGENERACY(METHOD,A,UMAX,NSTATE,U,UA,UB,LNGU,
...
c -----------------------------------------------------------------0
c *****************************************************************
c - calculate the degeneracy of each enthalpy state of Fe grains  -
c - for Fe we only consider Debye-thermal model, so we actually   -
c - do not need GU[] for Fe, thus we arbitrarily           -
c - set GU[]=1 for all states.
c ----------------------------------------------------------------- 	
